 ...
 * This handler validates API keys from request headers and manages
 * authentication state for the Provider service.
 */
public class AuthHandler {
     ...
     * Validates API key from request header before allowing access to protected routes.
     */
